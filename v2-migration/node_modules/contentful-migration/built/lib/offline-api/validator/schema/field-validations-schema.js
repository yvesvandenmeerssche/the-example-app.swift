...
const fieldValidations = Joi.alternatives().try(linkContentType, inValidation, linkMimetypeGroup, size, rangeValidation, regexp, unique, dateRange, assetImageDimensions, assetFileSize);
